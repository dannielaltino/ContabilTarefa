-- Script Revisado de acordo com o Dicionário de Dados v2.1 (08/04/2026)
-- Foco: Inclusão de tokens de acesso e correção de obrigatoriedades
...
CREATE TABLE usuario_cliente (
    ...
    userclienttoken        VARCHAR(255) NOT NULL, -- Incluído conforme DDP v2.1
    userclienttimestamp     DATETIME NOT NULL,     -- Incluído conforme DDP v2.1
...
CREATE TABLE usuario_contabilidade (
    ...
    tenant_id              INT NOT NULL,
    cpf_usuario            VARCHAR(14) NOT NULL,  -- Definido como NOT NULL conforme DDP
    accountingusertoken    VARCHAR(255) NOT NULL, -- Incluído conforme DDP v2.1
    accountingusertimestamp DATETIME NOT NULL,     -- Incluído conforme DDP v2.1
...
CREATE TABLE execucao_servico (
    ...
    usuario_cont_id         INT,                   -- Opcional conforme DDP
    usuario_cli_id          INT,                   -- Alterado para Opcional conforme DDP
    servico_id              INT NOT NULL,
